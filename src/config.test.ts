...
describe('getConfig', () => {
  describe('successful configuration', () => {
    ...
    it('should use provided REVERSE_PROXY_IPS and apply defaults', () => {
      ...
      expect(config.reverseProxyIps).toEqual(['xxx.xxx.xxx.xxx']);
    ...
    it('should parse multiple reverse proxy IPs from comma-separated string', () => {
      process.env.REVERSE_PROXY_IPS = 'xxx.xxx.xxx.xxx, xxx.xxx.xxx.xxx, xxx.xxx.xxx.xxx';

      const config = getConfig();

      expect(config.reverseProxyIps).toEqual(['xxx.xxx.xxx.xxx', 'xxx.xxx.xxx.xxx', 'xxx.xxx.xxx.xxx']);
    });

    it('should trim whitespace from reverse proxy IPs', () => {
      process.env.REVERSE_PROXY_IPS = '  xxx.xxx.xxx.xxx  ,  xxx.xxx.xxx.xxx  ';

      const config = getConfig();

      expect(config.reverseProxyIps).toEqual(['xxx.xxx.xxx.xxx', 'xxx.xxx.xxx.xxx']);
    });
