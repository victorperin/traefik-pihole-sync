...
export class PiHoleService {
   ...
   * Example: PUT /api/config/dns/hosts/192.168.1.200 domain.com
   */
   ...
   * Returns array like: ["192.168.1.200 domain1.com", "192.168.1.200 domain2.com"]
   */
  async listDnsRecords(): Promise<string[]> {
    try {
      ...
      // Response is an array like: ["192.168.1.200 domain1.com", "192.168.1.200 domain2.com"]
